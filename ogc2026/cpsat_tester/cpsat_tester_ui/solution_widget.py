"""
Solution visualization tab for cpsat_tester.
...
from cpsat_tester_ui.bay_layout_widget import (
    BayCanvas, BlockItem, _auto_scale,
    _layer_gray, _SCALE_MIN, _SCALE_MAX, _SCALE_STEP,
)
from cpsat_tester_ui.gantt_widget import GanttCanvas, _bay_color, _bay_color_dark
